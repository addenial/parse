...
'''
        ...
        #port_data.extend((ip_address, os_name))
        #port_data.extend((ip_address, os_match_name, os_accuracy))
        #port_data.extend((ip_address, os_type))
...
def parse_to_csv(data):
    ...
    if not os.path.isfile(csv_name):
        ...
        #ip,osfamily,vendor,osgen,type,os match name,accuracy
        top_row = [
            'IP', 'OS family', 'vendor', 'osgen', 'type',
            'os match name', 'accuracy'
        ]
        #top_row = [
